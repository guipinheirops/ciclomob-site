# Atualizações do funil

- Logo atual do Ciclo MOB aplicada no cabeçalho e rodapé.
- Planos atualizados:
  - Mensal: R$ 49,90/mês
  - Semestral: R$ 29,90/mês (R$ 179,40 a cada 6 meses)
  - Anual: R$ 9,90/mês (R$ 118,80/ano)
- CTAs conectados aos três checkouts da Cakto.
- Plano anual destacado como melhor valor.
- Mensagem pós-compra atualizada: acesso liberado automaticamente por e-mail após aprovação da Cakto.
- Link direto para o app adicionado ao rodapé.
